package com.mif50.mvvmnewsapp.data
...
import com.mif50.mvvmnewsapp.util.networkBoundResource
...
class NewsRepository @Inject constructor(
    ...
    fun getAllBookmarkedArticles(): Flow<List<NewsArticle>> = newsArticleDao.getAllBookmarkedArticles()
